...
class Scanning_port:
	...
	def __init__(self, master):
		...
		#ttk.LabelFrame(self.frame_report, height = 400, width = 400, text = "Scanning Report").pack()
	...
	def dscan(self):
		...
		#print('Please wait, scanning remote host', self.entry_name.get())
		...
		try:
			for port in range(1,1025):
				...
				if result == 0:
					...
					#+ "-->" + sock.recvfrom() ##UDP message recvfrom
